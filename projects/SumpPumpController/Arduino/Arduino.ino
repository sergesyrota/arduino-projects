...
void loop()
{
  ...
  if (net.messageReceived()) {
    if (net.assertCommand((char*)pgm_read_word(&(str_alertPresent))) || net.assertCommand((char*)pgm_read_word(&(str_alarmPresent)))) {
      if (alert.present) {
        if (alert.acknowledged) {
          net.sendResponse((char*)pgm_read_word(&(str_YES_Ack_ed)));
        } else {
          net.sendResponse((char*)pgm_read_word(&(str_YES)));
        }
      } else {
        net.sendResponse((char*)pgm_read_word(&(str_NO)));
      }
    } else if (net.assertCommand((char*)pgm_read_word(&(str_alertReason)))) {
      net.sendResponse(alert.condition);
    } else if (net.assertCommand((char*)pgm_read_word(&(str_getDistance)))) {
      net.sendResponse(itoa(readDistance(), buf, 10));
    } else if (net.assertCommand((char*)pgm_read_word(&(str_getPressure)))) {
      net.sendResponse(itoa(readPressure(), buf, 10));
    } else if (net.assertCommand((char*)pgm_read_word(&(str_getBattVoltage)))) {
      sprintf(buf, (char*)pgm_read_word(&(str_dmV)), readBatteryVoltage());
      net.sendResponse(buf);
    } else if (net.assertCommand((char*)pgm_read_word(&(str_getAcPumpOnTime)))) {
      ...
      net.sendResponse(buf);
    } else if (net.assertCommand((char*)pgm_read_word(&(str_getLastSelfTest)))) {
      sendSelfTestResponse();
    } else if (net.assertCommand((char*)pgm_read_word(&(str_forceAlert)))) {
      raiseAlert(ExternallyForced, (char*)pgm_read_word(&(str_Force_command)));
      net.sendResponse((char*)pgm_read_word(&(str_OK)));
    } else if (net.assertCommand((char*)pgm_read_word(&(str_resetAlert)))) {
      resetAlert();
      net.sendResponse((char*)pgm_read_word(&(str_OK)));
    } else if (net.assertCommand((char*)pgm_read_word(&(str_startSelfTest)))) {
      dcSelfTestStart();
      net.sendResponse((char*)pgm_read_word(&(str_OK)));
    } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_set)), buf)) {
      processSetCommands();
    } else if (net.assertCommand((char*)pgm_read_word(&(str_debug)))) {
      sendDebugResponse();
    } else {
      net.sendResponse((char*)pgm_read_word(&(str_Unrecognized_command)));
    }
  }
...
{
  if (net.assertCommandStarts((char*)pgm_read_word(&(str_setAlertBatteryVoltage)), buf)) {
    ...
    if (tmp > 9000 && tmp < 15000) {
      ...
      net.sendResponse((char*)pgm_read_word(&(str_ERROR)));
    }
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setAlertWaterLevel)), buf)) {
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setBaudRate)), buf)) {
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setAcPumpOnThreshold)), buf)) {
    int tmp = strtol(buf, NULL, 10);
    if (tmp > 0 && tmp < 1025) {
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setAlertPressureLevel)), buf)) {
    int tmp = strtol(buf, NULL, 10);
    if (tmp > 0 && tmp < 1025) {
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setAcPumpOnTimeWarning)), buf)) {
    int tmp = strtol(buf, NULL, 10);
    if (tmp > 0 && tmp < 30000) {
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setSelftestTimeBetween)), buf)) {
    long tmp = strtol(buf, NULL, 10);
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setSelfTestTimeLimit)), buf)) {
    int tmp = strtol(buf, NULL, 10);
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setSelfTestMinDepth)), buf)) {
    int tmp = strtol(buf, NULL, 10);
    if (tmp > -100 && tmp < 100) {
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setSelfTestDepthDiff)), buf)) {
    int tmp = strtol(buf, NULL, 10);
    if (tmp > 0 && tmp < 100) {
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setDepthMeasureTime)), buf)) {
    int tmp = strtol(buf, NULL, 10);
    if (tmp >= 0 && tmp < 120) {
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setBuzzerEnabled)), buf)) {
    int tmp = strtol(buf, NULL, 10);
    if (tmp == 1 || tmp == 0) {
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setZeroPressure)), buf)) {
    int tmp = strtol(buf, NULL, 10);
    if (tmp >= 0 && tmp < 1023) {
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setPointsPerCm)), buf)) {
    int tmp = strtol(buf, NULL, 10);
  ...
  } else if (net.assertCommandStarts((char*)pgm_read_word(&(str_setDcPumpOnTimeWarning)), buf)) {
    int tmp = strtol(buf, NULL, 10);
    if (tmp >= 1 && tmp < 3600) {
      ...
      net.sendResponse((char*)pgm_read_word(&(str_ERROR_1_3600_expected)));
    }
  } else {
    net.sendResponse((char*)pgm_read_word(&(str_Unrecognized_command)));
  }
...
{
  sprintf(buf, ((char*)pgm_read_word(&(str_time_lu))), now());
  net.responseSendPart(buf);
  sprintf(buf, ((char*)pgm_read_word(&(str_rangeLH_0_d_d))), range.lows[0], range.highs[0]);
  net.responseSendPart(buf);
  sprintf(buf, ((char*)pgm_read_word(&(str_rangeLH_1_d_d))), range.lows[1], range.highs[1]);
  net.responseSendPart(buf);
  sprintf(buf, ((char*)pgm_read_word(&(str_DcHeight_d_d))), selftest.startingHeight, selftest.endingHeight);
  net.responseSendPart(buf);
  sprintf(buf, ((char*)pgm_read_word(&(str_pressure_d))), analogRead(PRESSURE_SENSOR_PIN));
  net.responseSendPart(buf);
  sprintf(buf, ((char*)pgm_read_word(&(str_AcPumpCycles_d))), acpump.onCycles);
  net.responseSendPart(buf);
  sprintf(buf, ((char*)pgm_read_word(&(str_lastAlertTime_lu))), alert.timeTriggered);
  net.responseSendPart(buf);
  sprintf(buf, ((char*)pgm_read_word(&(str_rawDepthPressure_d))), analogRead(DEPTH_PRESSURE_SENSOR_PIN));
  net.responseSendPart(buf);
//  sprintf(buf, );
//  net.responseSendPart(buf);
//  sprintf(buf, );
...
{
   sprintf(buf, ((char*)pgm_read_word(&(str_timeSince_lu))), (now() - selftest.lastTestTime));
   net.responseSendPart(buf);
   sprintf(buf, ((char*)pgm_read_word(&(str_cyclesSince_d))), acpump.onCycles-selftest.acCycles);
   net.responseSendPart(buf);
   sprintf(buf, ((char*)pgm_read_word(&(str_voltage_d))), selftest.batteryVoltageMv);
   net.responseSendPart(buf);
   sprintf(buf, ((char*)pgm_read_word(&(str_length_d))), (int)selftest.testLength);
   net.responseSendPart(buf);
   sprintf(buf, ((char*)pgm_read_word(&(str_pumpedHeight_d))), selftest.startingHeight - selftest.endingHeight);
   net.responseSendPart(buf);
   sprintf(buf, ((char*)pgm_read_word(&(str_result_d))), selftest.passed);
   net.responseSendPart(buf);
   net.responseEnd();
}
...
//  }
  ...
  if ((selftest.startingHeight - distance > conf.selfTestDepthDiff) || (now() - selftest.lastTestTime > conf.selfTestTimeLimit)) {
    ...
    if (selftest.batteryVoltageMv < conf.alertBatteryVoltage) {
      ...
      sprintf(buf, ((char*)pgm_read_word(&(str_Weak_battery_dmV))), selftest.batteryVoltageMv);
    ...
    if (selftest.startingHeight - selftest.endingHeight < 5) {
      selftest.passed = false;
      sprintf(buf, ((char*)pgm_read_word(&(str_DC_Pump_failure_dCM_pumped_in_d_sec))), (selftest.startingHeight - selftest.endingHeight), (int)selftest.testLength);
      raiseAlert(DcPumpMalfunction, buf);
      return;
    }
...
unsigned int readDcPumpVoltage()
{
  ...
  if (mv > 9000 && (now() - selftest.lastTestTime) > (conf.selfTestTimeLimit + 6)) {
    raiseAlert(DcPumpActivated, ((char*)pgm_read_word(&(str_DC_Pump_ON))));
    ...
    if (!dcpump.currentlyOn) {
      ...
      raiseAlert(DcPumpOverload, ((char*)pgm_read_word(&(str_DC_pump_ON_too_long))));
    }
  } else {
...
unsigned int readBatteryVoltage() 
{
  ...
  if (mv < conf.alertBatteryVoltage) {
    raiseAlert(DischargedBattery, ((char*)pgm_read_word(&(str_Battery_voltage))));
  }
  return mv;
}
...
int readDistance()
{
  ...
  if (range.distance > conf.alertWaterLevel) {
    char tmp[40];
    sprintf(tmp, ((char*)pgm_read_word(&(str_Water_level_d))), range.distance);
...
int readPressure()
{
  ...
  if (acpump.lastPressure > conf.alertPressureLevel) {
    raiseAlert(HighPressure, ((char*)pgm_read_word(&(str_High_pressure))));
  }
  ...
  if (currentlyOn) {
    if ((now() - acpump.switchOnTime) > conf.acPumpOnTimeWarning) {
      raiseAlert(AcPumpOverload, ((char*)pgm_read_word(&(str_AC_pump_ON_for_too_long))));
    }
  }
